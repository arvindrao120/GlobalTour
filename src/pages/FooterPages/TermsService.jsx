      ...
      <div className="lg:p-16 ">
        <div>
          ...
          <div className="space-y-5 rounded-lg shadow-2xl shadow-orange-400   p-10 mx-auto w-full lg:max-w-3/4 text-xl">
            <h2 className="text-4xl font-bold  py-3"> General</h2>
            <div className="px-4 lg:px-16 w-full  h-[4px] bg-orange-400 "></div>
            <h3 className="text-3xl font-bold ">Agreement</h3>
            <p>
              We, Team Global India Tours, run a website called Global India
              Tours, which is a platform where users find and book the best
            ...
            <p>
              ...
              Website is owned and operated by Global India Tours, (“Global
              India Tours”). The Website is offered subject to your acceptance
              without modification of the terms and conditions contained herein
              and all other operating rules, policies and procedures that may be
              published (collectively, the “Agreement”).
            </p>
            <p>
            ...
            <p>
              ...
              Website. By using the Website and by agreeing to these terms and
            ...
            <p>
              ...
              these terms and conditions, you consent to Global India Tours’s
              use of cookies in accordance with the terms of Global India
              Tours’s privacy policy.
            </p>
            <h3 className="text-3xl font-bold ">License to Use Website</h3>
            <p>
              Unless otherwise stated, Global India Tours and/or its licensors
              own the intellectual property rights in the website and material
              on the website. Subject to the license below, all these
            ...
            <p>
              ...
              Website without Global India Tours’s express written consent.
            </p>
            <p>
            ...
            <p>
              ...
              marketing without Global India Tours’s express written consent.
            </p>
            <h3 className="text-3xl font-bold ">Restricted Access</h3>
            <p>
            ...
            <p>
              ...
              content or services, you must ensure that your user ID and
            ...
            <h2 className="text-4xl font-bold py-3"> Other</h2>
            <div className="px-4 lg:px-16 w-full  h-[4px] bg-orange-400 "></div>
            ...
            <p>
              ...
              Agreement constitutes acceptance of those changes. Global India
              Tours may also, in the future, offer new features and/or services,
              which shall be subject to the terms and conditions of this
              Agreement.
            </p>
            <h3 className="text-3xl font-bold ">Termination</h3>
            <p>
              Global India Tours may terminate your access to the Website at any
              time, with or without cause or notice, effective immediately. If
              you wish to terminate this Agreement or your Global India Tours
              account, you may simply discontinue using the Website. All
            ...
            <h3 className="text-3xl font-bold ">Warranties</h3>
            ...
            <h3 className="text-3xl font-bold ">Liability</h3>
            <p>
              In no event will Global India Tours, or its suppliers or
              ...
              loss or corruption of data; or (iv) for any amounts that exceed
              the fees paid by you to Global India Tours under this agreement.
              Global India Tours shall have no liability for any failure or
              delay due to matters beyond their reasonable control.
            </p>
            <p>
              Nothing in the Website disclaimer will exclude or limit any
              warranty implied by law that it would be unlawful to exclude or
              limit; and nothing in the Website disclaimer will exclude or limit
              Global India Tours’s liability in respect of any: (i) fraud or
              fraudulent misrepresentation on the part of Global India Tours; or
              (ii) matter which would be illegal or unlawful for Global India
              Tours to exclude or limit, or to attempt or purport to exclude or
              limit, its liability.
            </p>
            <h3 className="text-3xl font-bold ">Reasonableness</h3>
            <p>
              By using the Website, you agree that the exclusions and
              limitations of liability set out in the Website disclaimer are
              reasonable.
            </p>
            <p>
            ...
            <h3 className="text-3xl font-bold ">Other Parties</h3>
            <p>
            ...
            <h3 className="text-3xl font-bold ">Unenforceable ProvisionsM</h3>
            <p>
              If any provision of the Website disclaimer is, or is found to be,
              unenforceable under applicable law, that will not effect the
              enforceability of the other provisions of the Website terms and
              conditions.
            </p>
            <h3 className="text-3xl font-bold ">Representation</h3>
            <p>
              ...
              or regulations in your country, regarding online conduct and
              ...
              which you reside) and (ii) your use will not infringe or
            ...
            <p>
              ...
              ("Content") to Global India Tours for inclusion on the Website,
              you grant Global India Tours a world-wide, irrevocable,
              royalty-free, and non-exclusive license to use, reproduce, adapt,
              publish, translate, modify and distribute the Content in any
              existing or future media. You also grant to Global India Tours the
              right to sub-license these rights and the right to bring an action
              for infringement of these rights. If you want Content removed,
              Global India Tours will assess the impact on the system and the
              time involved and remove content at will at its own full
              discretion.
            </p>
            <p>
              ...
              rise to legal action whether against you or Global India Tours or
              a third party (in each case under any applicable law) You must not
              submit any Content to the Website that is or has ever been the
              subject of any threatened or actual legal proceedings or other
              similar complaint.
            </p>
            <p>
              Global India Tours reserves the right to edit or remove any
              material submitted to the Website, or stored on Global India
              Tours’s servers, or hosted or published upon the Website.
              Notwithstanding Global India Tours’s rights under these terms and
              conditions in relation to Content, Global India Tours does not
            ...
            <p>
              You hereby indemnify Global India Tours and undertake to keep
              Global India Tours indemnified against any losses, damages, costs,
              liabilities and expenses (including without limitation legal
              expenses and any amounts paid by Global India Tours to a third
              party in settlement of a claim or dispute on the advise of Global
              India Tours’s legal advisers) incurred or suffered by Global India
              Tours arising out of any breach by you of any provision of these
            ...
            <h3 className="text-3xl font-bold ">Assignment</h3>
            <p>
              Global India Tours may transfer, sub-contract or otherwise deal
              with Global India Tours’s rights and/or obligations under these
            ...
            <p>
              ...
              rights and/or obligations under theses terms and conditions.
            </p>
            <h3 className="text-3xl font-bold ">Severability</h3>
            <p>
              If a provision of these terms and conditions is deemed by any
            ...
            <h3 className="text-3xl font-bold ">Entire Agreement</h3>
            <p>
            ...
            <h3 className="text-3xl font-bold ">Law and Jurisdiction</h3>
            <p>
              These terms and conditions will be governed by and construed in
              accordance with Indian Law, and any disputes relating to these
